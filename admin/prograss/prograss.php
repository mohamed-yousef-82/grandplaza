...
<h3 class='table-title'><span><?php echo lang('PROGRASS') ?></span><i class='fa fa-building' aria-hidden='true'></i></h3>
...
<div id="data"></div>
      ...
      <!--Add Name--->
      <input type="text" name="name" placeholder="<?php echo lang('TITLE') ?>" required="required">
      <!--Add Number--->
