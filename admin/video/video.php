...
<h3 class='table-title'><span>Videos</span><i class='fa fa-building' aria-hidden='true'></i></h3>
...
<div id="data"></div>
      ...
      <!--Add Name--->
      <input type="text" name="name" placeholder="<?php echo lang('TITLE') ?>" required="required" id="title">
      <!--Add Image--->
      <label>كود الفيديو</label>
